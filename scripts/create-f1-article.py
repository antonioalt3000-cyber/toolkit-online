...
article = """The EU AI Act is now in force -- and if you build, sell, or deploy AI systems in Europe, you need to know exactly where your product sits in the risk hierarchy. The wrong classification can mean anything from minor documentation requirements to a complete market ban.
...
with open('C:/Users/ftass/toolkit-online/scripts/article-f1-content.json', 'w', encoding='utf-8') as f:
    json.dump({'content': article}, f, ensure_ascii=False)

print('Article saved, chars:', len(article))
