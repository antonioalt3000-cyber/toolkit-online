  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'We love hearing from our users and your feedback directly shapes the future of ToolKit Online. Whether you have a suggestion for a new tool, want to report a bug, have a question about how something works, or simply want to share your experience, we are always happy to listen. Reach out to us at info@toolkitonline.vip and we will get back to you as quickly as possible. Your ideas have already helped us grow from a small project to a platform with over 114 tools, and we cannot wait to hear what you think we should build next.',
      },
    ],
  },
  it: {
    ...
    sections: [
      ...
      {
        heading: 'Contattaci',
        body: 'Amiamo ascoltare i nostri utenti e il vostro feedback plasma direttamente il futuro di ToolKit Online. Che tu abbia un suggerimento per un nuovo strumento, voglia segnalare un bug, abbia una domanda su come funziona qualcosa o semplicemente voglia condividere la tua esperienza, siamo sempre felici di ascoltarti. Scrivici a info@toolkitonline.vip e ti risponderemo il prima possibile. Le vostre idee ci hanno già aiutato a crescere da un piccolo progetto a una piattaforma con oltre 114 strumenti, e non vediamo l\'ora di scoprire cosa pensate dovremmo costruire dopo.',
      },
    ],
  },
  es: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'ToolKit Online es completamente gratuito y siempre lo será. No hay muros de pago, niveles premium, períodos de prueba ni costos ocultos. Sostenemos nuestra plataforma a través de publicidad no intrusiva que respeta tu experiencia de navegación. Tomamos la decisión deliberada de mantener cada herramienta accesible para todos, porque creemos que el software útil no debe estar bloqueado detrás de una suscripción. Ya uses una herramienta o las 114, nunca se te pedirá que pagues un centavo.',
      },
      {
  ...
  fr: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'ToolKit Online est entièrement gratuit et le restera toujours. Il n\'y a pas de paywall, pas de niveau premium, pas de période d\'essai et pas de coûts cachés. Nous soutenons notre plateforme grâce à une publicité non intrusive qui respecte votre expérience de navigation. Nous avons fait le choix délibéré de garder chaque outil accessible à tous, car nous croyons que les logiciels utiles ne doivent pas être verrouillés derrière un abonnement. Que vous utilisiez un outil ou les 114, on ne vous demandera jamais de payer quoi que ce soit.',
      },
      {
  ...
  de: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'ToolKit Online ist komplett kostenlos und wird es immer bleiben. Es gibt keine Paywalls, keine Premium-Stufen, keine Testphasen und keine versteckten Kosten. Wir finanzieren unsere Plattform durch unaufdringliche Werbung, die Ihr Surferlebnis respektiert. Wir haben die bewusste Entscheidung getroffen, jedes einzelne Werkzeug für alle zugänglich zu halten, weil wir glauben, dass nützliche Software nicht hinter einem Abonnement verschlossen sein sollte. Ob Sie ein Werkzeug oder alle 114 nutzen, Sie werden niemals gebeten, einen Cent zu zahlen.',
      },
      {
