  ...
  const seoContent: Record<Locale, { title: string; paragraphs: string[]; faq: { q: string; a: string }[] }> = {
    en: {
      ...
      paragraphs: [
        ...
        '<h2 class="text-xl font-semibold text-gray-800 mt-4 mb-2">Character Counter for Academic Writing and Exams</h2>Students and academics regularly face strict character limits. College application essays, such as the Common App personal statement, allow exactly 650 words but many supplemental essays impose a character limit instead — for example, 150 characters for a "Why this major?" response. Standardised test essays, scholarship applications, and abstract submissions for conferences all use character counts rather than word counts. This character counter lets you verify your text meets exact requirements before submission, avoiding the risk of automatic truncation or disqualification.',
        '<h2 class="text-xl font-semibold text-gray-800 mt-4 mb-2">How to Use This Free Character Counter</h2>Using our character counter is straightforward: paste or type your text into the input box and the results update instantly. You will see total characters, characters without spaces, word count, sentence count, vowels, consonants, digits, special characters, and the most frequent letter — all in real time. Click the preset buttons for Twitter (280), SMS (160), meta description (160), or title tag (60) to instantly see whether your text fits within platform limits. The copy button lets you save the full analysis to your clipboard with one click, and the history panel keeps track of your recent analyses.',
        '<h2 class="text-xl font-semibold text-gray-800 mt-4 mb-2">Character Counting for Developers and Data Entry</h2>Programmers and database administrators need precise character counts for field validation, database column sizing (VARCHAR limits), API payload constraints, and form input restrictions. Knowing the exact character length of user input helps prevent truncation errors and data loss. If you work with code, try our <a href="/${lang}/tools/json-formatter">JSON formatter</a> for structured data or <a href="/${lang}/tools/regex-tester">regex tester</a> for pattern matching. For URL-safe strings, our <a href="/${lang}/tools/url-encoder">URL encoder</a> is a useful companion tool.',
