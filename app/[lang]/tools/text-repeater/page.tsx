  ...
  const seoContent: Record<Locale, { title: string; paragraphs: string[]; faq: { q: string; a: string }[] }> = {
    en: {
      ...
      paragraphs: [
        ...
        'Need to analyze the generated text? Use our <a href="/en/tools/word-counter">word counter</a> to check the exact length of your output. To change the formatting of repeated text — for example converting it all to uppercase or lowercase — try the <a href="/en/tools/text-case-converter">text case converter</a>. You can also count individual <a href="/en/tools/character-counter">characters</a> or find <a href="/en/tools/word-frequency-counter">word frequencies</a> in your repeated text.',
      ],
      faq: [
    ...
    es: {
      ...
      paragraphs: [
        ...
        'Si necesitas analizar el texto generado, usa nuestro <a href="/es/tools/word-counter">contador de palabras</a> para verificar la longitud exacta. Para cambiar el formato del texto repetido, prueba el <a href="/es/tools/text-case-converter">convertidor de mayusculas y minusculas</a>.',
      ],
      faq: [
