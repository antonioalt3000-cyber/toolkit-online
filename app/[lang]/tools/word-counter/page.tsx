  ...
  const seoContent: Record<Locale, { title: string; paragraphs: string[]; faq: { q: string; a: string }[] }> = {
    ...
    es: {
      ...
      paragraphs: [
        ...
        'La estimación del tiempo de lectura se basa en la velocidad promedio de lectura de un adulto de 200 palabras por minuto. Es la misma fórmula que usan plataformas como Medium para mostrar tiempos de lectura estimados. Explora también nuestro <a href="/es/tools/character-counter" class="text-blue-600 underline">Contador de Caracteres</a> y el <a href="/es/tools/text-case-converter" class="text-blue-600 underline">Convertidor de Mayúsculas/Minúsculas</a> para más herramientas de análisis de texto.',
      ],
      faq: [
