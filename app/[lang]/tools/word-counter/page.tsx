...
export default function WordCounter() {
  ...
  const seoContent: Record<Locale, { title: string; paragraphs: string[]; faq: { q: string; a: string }[] }> = {
    ...
    es: {
      ...
      paragraphs: [
        'Ya seas un estudiante terminando un ensayo, un blogger redactando una publicación o un redactor cumpliendo con un límite estricto, contar palabras de forma precisa es fundamental para entregar un trabajo de calidad. Nuestro contador de palabras online gratuito te ofrece estadísticas instantáneas y detalladas en el momento en que escribes o pegas tu contenido, sin necesidad de registro ni descargas.',
        'Más allá de contar palabras online, esta calculadora de palabras desglosa tu texto en caracteres (con y sin espacios), oraciones, párrafos y tiempo de lectura estimado. También muestra la longitud promedio de tus palabras, la palabra más larga y las cinco palabras más frecuentes. Estas métricas son esenciales para optimizar contenido SEO, respetar los límites de redes sociales, cumplir requisitos académicos y perfeccionar la escritura profesional.',
        'Los motores de búsqueda como Google consideran la longitud del contenido como uno de los factores de posicionamiento. Los artículos entre 1.500 y 2.500 palabras tienden a clasificarse mejor para palabras clave competitivas. Con este contador de palabras puedes verificar al instante si tu artículo, entrada de blog o página de producto alcanza la extensión recomendada antes de publicarlo.',
        '¿Necesitas analizar tu texto con más detalle? Nuestro <a href="/es/tools/character-counter" class="text-blue-600 underline">Contador de Caracteres</a> te permite verificar límites exactos para Twitter, Instagram o LinkedIn. Si trabajas con código o datos estructurados, el <a href="/es/tools/line-counter" class="text-blue-600 underline">Contador de Líneas</a> te muestra el número de líneas, líneas vacías y líneas con contenido. Y para dar formato uniforme a títulos y encabezados, prueba el <a href="/es/tools/text-case-converter" class="text-blue-600 underline">Convertidor de Mayúsculas/Minúsculas</a>.',
        'La estimación del tiempo de lectura se basa en la velocidad promedio de un adulto de 200 palabras por minuto, la misma fórmula que utilizan plataformas como Medium y WordPress. Esta información ayuda a los lectores a decidir si quieren comprometerse con un artículo y a los creadores de contenido a ajustar la extensión de sus textos según la audiencia objetivo.',
        'Nuestro contador de palabras funciona completamente en tu navegador: no enviamos tu texto a ningún servidor, lo que garantiza privacidad total. Puedes usarlo en cualquier dispositivo — ordenador, tablet o móvil — sin instalar nada. Es la herramienta ideal para estudiantes, periodistas, traductores, community managers y cualquier profesional que necesite contar palabras online de manera rápida y fiable.',
      ],
      faq: [
        { q: '¿Cómo calcula las palabras este contador de palabras?', a: 'La herramienta divide tu texto por espacios en blanco (espacios, tabulaciones, saltos de línea) y cuenta cada segmento resultante. Es el mismo método que usan los procesadores de texto más populares como Microsoft Word, Google Docs y LibreOffice Writer. Los signos de puntuación pegados a una palabra no generan conteos adicionales.' },
        { q: '¿El contador de palabras funciona con idiomas además del español?', a: 'Sí. Nuestro contador de palabras online funciona con cualquier idioma que separe palabras mediante espacios, incluyendo inglés, francés, alemán, italiano y portugués. Para idiomas como el chino o el japonés, que no utilizan espacios entre palabras, el conteo reflejará los segmentos separados por espacios.' },
        { q: '¿Cómo se estima el tiempo de lectura?', a: 'El tiempo de lectura se calcula dividiendo el total de palabras entre 200, que es la velocidad promedio de lectura de un adulto en palabras por minuto según estudios de comprensión lectora. El resultado se redondea hacia arriba, con un mínimo de 1 minuto. Para textos técnicos o académicos, la velocidad real puede ser menor (150-180 palabras por minuto).' },
        { q: '¿Puedo usar esta herramienta para verificar límites de caracteres en redes sociales?', a: 'Por supuesto. Twitter/X permite 280 caracteres, las descripciones de Instagram hasta 2.200 caracteres, las publicaciones de LinkedIn un máximo de 3.000 caracteres, y los títulos de YouTube hasta 100 caracteres. Usa el conteo de caracteres (con o sin espacios) para asegurarte de no superar estos límites. Para un análisis más detallado de caracteres, prueba nuestro Contador de Caracteres dedicado.' },
        { q: '¿Mi texto se almacena o se envía a un servidor?', a: 'No. Todo el procesamiento de nuestro contador de palabras ocurre completamente en tu navegador usando JavaScript. Tu texto nunca sale de tu dispositivo y no se almacena en ninguna base de datos. Esto garantiza privacidad total, algo especialmente importante si trabajas con documentos confidenciales, contratos o información personal.' },
      ],
    },
    fr: {
