...
export default function ImageResizer() {
  ...
  const seoContent: Record<Locale, { title: string; paragraphs: string[]; faq: { q: string; a: string }[] }> = {
    ...
    es: {
      title: 'Redimensionador de Im\u00e1genes: Cambia las Dimensiones al Instante',
      paragraphs: [
        'Redimensionar im\u00e1genes es una de las tareas m\u00e1s comunes en los flujos de trabajo de medios digitales. Ya sea que est\u00e9s preparando fotos para redes sociales, creando miniaturas para un blog o cumpliendo requisitos de dimensiones espec\u00edficos para una plataforma, tener un redimensionador confiable es esencial. Nuestra herramienta gratuita basada en navegador procesa todo localmente en tu dispositivo, garantizando total privacidad.',
        'La herramienta ofrece dimensiones predefinidas para las plataformas m\u00e1s populares: Post de Instagram (1080x1080), Historia de Instagram (1080x1920), Portada de Facebook (820x312), Miniatura de YouTube (1280x720), Encabezado de Twitter (1500x500), Banner de LinkedIn (1584x396) y resoluciones est\u00e1ndar como HD (1920x1080) y 4K (3840x2160).',
        'La funci\u00f3n de bloqueo de proporci\u00f3n, activada por defecto, asegura que tus im\u00e1genes mantengan sus proporciones originales al ajustar ancho o alto. Esto previene distorsi\u00f3n y estiramiento, cr\u00edtico para resultados profesionales. Cuando necesites dimensiones espec\u00edficas diferentes de la proporci\u00f3n original, simplemente desactiva el bloqueo.',
        'Puedes exportar im\u00e1genes redimensionadas en formato JPEG, PNG o WebP con un control de calidad ajustable del 10% al 100%. JPEG es ideal para fotograf\u00edas con excelente compresi\u00f3n. PNG preserva transparencia y bordes n\u00edtidos. WebP ofrece compresi\u00f3n moderna, t\u00edpicamente 25-30% m\u00e1s peque\u00f1a que JPEG a calidad equivalente.'
      ],
      faq: [
        { q: '\u00bfSe sube mi imagen a alg\u00fan servidor?', a: 'No. Todo el redimensionamiento se realiza localmente en tu navegador usando la API Canvas de HTML5. Tu imagen nunca sale de tu dispositivo, garantizando completa privacidad y seguridad.' },
        { q: '\u00bfRedimensionar reduce la calidad de la imagen?', a: 'Agrandar una imagen m\u00e1s all\u00e1 de sus dimensiones originales puede reducir la calidad. Reducir generalmente mantiene bien la calidad. Usa el control para ajustar la calidad del archivo de salida.' },
        { q: '\u00bfQu\u00e9 es el bloqueo de proporci\u00f3n y cu\u00e1ndo usarlo?', a: 'El bloqueo de proporci\u00f3n mantiene la relaci\u00f3n ancho-alto original. Mant\u00e9nlo activado para evitar distorsi\u00f3n. Desact\u00edvalo cuando necesites dimensiones exactas diferentes de la proporci\u00f3n original.' },
        { q: '\u00bfQu\u00e9 formato de salida elegir?', a: 'Usa JPEG para fotograf\u00edas sin transparencia. PNG cuando necesites transparencia o calidad sin p\u00e9rdida. WebP para la mejor relaci\u00f3n compresi\u00f3n-calidad, ideal para web.' },
        { q: '\u00bfPuedo redimensionar im\u00e1genes a resoluci\u00f3n 4K?', a: 'S\u00ed. Puedes redimensionar a cualquier dimensi\u00f3n incluyendo 4K (3840x2160). Sin embargo, agrandar una imagen peque\u00f1a a 4K resultar\u00e1 en p\u00e9rdida de calidad.' }
      ]
    },
    fr: {
