  ...
  const seoContent: Record<Locale, { title: string; paragraphs: string[]; faq: { q: string; a: string }[] }> = {
    en: {
      ...
      paragraphs: [
        ...
        'Keep in mind that calorie calculators provide estimates, not exact figures. Individual metabolism varies based on genetics, body composition, hormones, sleep quality, and stress levels. Use these numbers as a starting point and adjust based on your actual results over 2-4 weeks. For a complete health assessment, explore also our <a href="/en/tools/bmi-calculator" class="text-blue-600 underline">BMI Calculator</a>, <a href="/en/tools/body-fat-calculator" class="text-blue-600 underline">Body Fat Calculator</a>, and <a href="/en/tools/water-intake-calculator" class="text-blue-600 underline">Water Intake Calculator</a>.',
      ],
      faq: [
    ...
    it: {
      ...
      paragraphs: [
        ...
        'Ricorda che i calcolatori di calorie forniscono stime, non cifre esatte. Il metabolismo individuale varia in base a genetica, composizione corporea, ormoni e stress. Usa questi numeri come punto di partenza e aggiusta in base ai risultati reali. Per una valutazione completa della salute, scopri anche il nostro <a href="/it/tools/bmi-calculator" class="text-blue-600 underline">Calcolatore BMI</a>, il <a href="/it/tools/body-fat-calculator" class="text-blue-600 underline">Calcolatore di Grasso Corporeo</a> e il <a href="/it/tools/water-intake-calculator" class="text-blue-600 underline">Calcolatore di Idratazione</a>.',
      ],
      faq: [
    ...
    es: {
      ...
      paragraphs: [
        ...
        'Recuerda que las calculadoras proporcionan estimaciones. El metabolismo individual varía según genética, composición corporal y hormonas. Usa estos números como punto de partida y ajusta según tus resultados reales. Para una evaluación completa de tu salud, explora también nuestra <a href="/es/tools/bmi-calculator" class="text-blue-600 underline">Calculadora de IMC</a>, la <a href="/es/tools/body-fat-calculator" class="text-blue-600 underline">Calculadora de Grasa Corporal</a> y la <a href="/es/tools/water-intake-calculator" class="text-blue-600 underline">Calculadora de Hidratación</a>.',
      ],
      faq: [
    ...
    fr: {
      ...
      paragraphs: [
        ...
        'N\'oubliez pas que les calculateurs fournissent des estimations. Le métabolisme individuel varie selon la génétique, la composition corporelle et les hormones. Utilisez ces chiffres comme point de départ. Pour une évaluation complète de votre santé, découvrez aussi notre <a href="/fr/tools/bmi-calculator" class="text-blue-600 underline">Calculateur d\'IMC</a>, le <a href="/fr/tools/body-fat-calculator" class="text-blue-600 underline">Calculateur de Graisse Corporelle</a> et le <a href="/fr/tools/water-intake-calculator" class="text-blue-600 underline">Calculateur d\'Hydratation</a>.',
      ],
      faq: [
    ...
    de: {
      ...
      paragraphs: [
        ...
        'Bedenken Sie, dass Kalorienrechner Schätzungen liefern. Der individuelle Stoffwechsel variiert je nach Genetik, Körperzusammensetzung und Hormonen. Nutzen Sie diese Zahlen als Ausgangspunkt. Für eine umfassende Gesundheitsbewertung entdecken Sie auch unseren <a href="/de/tools/bmi-calculator" class="text-blue-600 underline">BMI-Rechner</a>, den <a href="/de/tools/body-fat-calculator" class="text-blue-600 underline">Körperfettrechner</a> und den <a href="/de/tools/water-intake-calculator" class="text-blue-600 underline">Wasserbedarfsrechner</a>.',
      ],
      faq: [
    ...
    pt: {
      ...
      paragraphs: [
        ...
        'Lembre-se que calculadoras fornecem estimativas. O metabolismo individual varia conforme genética, composição corporal e hormônios. Use esses números como ponto de partida. Para uma avaliação completa da saúde, explore também nossa <a href="/pt/tools/bmi-calculator" class="text-blue-600 underline">Calculadora de IMC</a>, a <a href="/pt/tools/body-fat-calculator" class="text-blue-600 underline">Calculadora de Gordura Corporal</a> e a <a href="/pt/tools/water-intake-calculator" class="text-blue-600 underline">Calculadora de Hidratação</a>.',
      ],
      faq: [
