...
const seoContent: Record<Locale, { title: string; paragraphs: string[]; faq: { q: string; a: string }[] }> = {
  en: {
    ...
    paragraphs: [
      ...
      'Whether you are a student working on math homework, a professional analyzing business data, or a shopper trying to figure out a sale price, this tool provides instant and accurate results. No formulas to remember, no manual calculations — just enter your numbers and get the answer immediately. The calculator works with decimals and negative numbers, making it versatile for any scenario. For specific use cases, try our <a href="/en/tools/discount-calculator" class="text-blue-600 underline">discount calculator</a> for shopping savings, <a href="/en/tools/vat-calculator" class="text-blue-600 underline">VAT calculator</a> for tax amounts, or <a href="/en/tools/tip-calculator" class="text-blue-600 underline">tip calculator</a> for restaurant bills.',
    ],
    faq: [
  ...
  it: {
    ...
    paragraphs: [
      ...
      'Che tu sia uno studente, un professionista che analizza dati aziendali o un consumatore che cerca di capire un prezzo scontato, questo strumento fornisce risultati istantanei e accurati. Nessuna formula da ricordare, nessun calcolo manuale — inserisci i tuoi numeri e ottieni la risposta immediatamente. Per casi specifici, prova il nostro <a href="/it/tools/discount-calculator" class="text-blue-600 underline">calcolatore di sconti</a> per i risparmi sugli acquisti, il <a href="/it/tools/vat-calculator" class="text-blue-600 underline">calcolatore IVA</a> per gli importi fiscali, o il <a href="/it/tools/tip-calculator" class="text-blue-600 underline">calcolatore di mance</a> per i conti al ristorante.',
    ],
    faq: [
  ...
  es: {
    ...
    paragraphs: [
      ...
      'Ya seas estudiante, profesional que analiza datos empresariales o consumidor intentando descifrar un precio de oferta, esta herramienta proporciona resultados instantaneos y precisos. Sin formulas que recordar, sin calculos manuales — solo introduce tus numeros y obtendras la respuesta inmediatamente. Para casos especificos, prueba nuestra <a href="/es/tools/discount-calculator" class="text-blue-600 underline">calculadora de descuentos</a>, la <a href="/es/tools/vat-calculator" class="text-blue-600 underline">calculadora de IVA</a> o la <a href="/es/tools/tip-calculator" class="text-blue-600 underline">calculadora de propinas</a>.',
    ],
    faq: [
  ...
  fr: {
    ...
    paragraphs: [
      ...
      'Que vous soyez etudiant, professionnel analysant des donnees ou consommateur essayant de comprendre un prix en solde, cet outil fournit des resultats instantanes et precis. Aucune formule a retenir, aucun calcul manuel — entrez simplement vos chiffres et obtenez la reponse immediatement. Pour des cas specifiques, essayez notre <a href="/fr/tools/discount-calculator" class="text-blue-600 underline">calculateur de remises</a>, le <a href="/fr/tools/vat-calculator" class="text-blue-600 underline">calculateur de TVA</a> ou le <a href="/fr/tools/tip-calculator" class="text-blue-600 underline">calculateur de pourboires</a>.',
    ],
    faq: [
  ...
  de: {
    ...
    paragraphs: [
      ...
      'Ob Sie Student, Berufstaetiger bei der Datenanalyse oder Verbraucher sind — dieses Tool liefert sofortige und genaue Ergebnisse. Keine Formeln merken, keine manuellen Berechnungen — geben Sie einfach Ihre Zahlen ein und erhalten Sie sofort die Antwort. Fuer spezifische Faelle probieren Sie unseren <a href="/de/tools/discount-calculator" class="text-blue-600 underline">Rabattrechner</a>, den <a href="/de/tools/vat-calculator" class="text-blue-600 underline">MwSt.-Rechner</a> oder den <a href="/de/tools/tip-calculator" class="text-blue-600 underline">Trinkgeldrechner</a>.',
    ],
    faq: [
  ...
  pt: {
    ...
    paragraphs: [
      ...
      'Seja estudante, profissional a analisar dados ou consumidor a tentar perceber um preco de saldo, esta ferramenta fornece resultados instantaneos e precisos. Sem formulas para decorar, sem calculos manuais — basta introduzir os seus numeros e obter a resposta imediatamente. Para casos especificos, experimente a nossa <a href="/pt/tools/discount-calculator" class="text-blue-600 underline">calculadora de descontos</a>, a <a href="/pt/tools/vat-calculator" class="text-blue-600 underline">calculadora de IVA</a> ou a <a href="/pt/tools/tip-calculator" class="text-blue-600 underline">calculadora de gorjetas</a>.',
    ],
    faq: [
