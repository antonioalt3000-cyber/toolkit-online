      ...
      <div className="max-w-2xl mx-auto">
        ...
        <article className="mt-12 prose prose-gray max-w-none">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            {lang === 'it' && <>Se lavori con dati strutturati, potrebbero interessarti anche il nostro <a href={`/${lang}/tools/csv-to-json`} className="text-blue-600 hover:underline">convertitore CSV in JSON</a>, il <a href={`/${lang}/tools/base64-converter`} className="text-blue-600 hover:underline">convertitore Base64</a> per codificare dati binari, e il <a href={`/${lang}/tools/regex-tester`} className="text-blue-600 hover:underline">tester di espressioni regolari</a> per filtrare o estrarre dati JSON.</>}
            {lang === 'en' && <>If you work with structured data, you may also find our <a href={`/${lang}/tools/csv-to-json`} className="text-blue-600 hover:underline">CSV to JSON converter</a>, the <a href={`/${lang}/tools/base64-converter`} className="text-blue-600 hover:underline">Base64 converter</a> for encoding binary data, and the <a href={`/${lang}/tools/regex-tester`} className="text-blue-600 hover:underline">regex tester</a> for filtering or extracting JSON data useful.</>}
            {lang === 'es' && <>Si trabajas con datos estructurados, también te pueden ser útiles nuestro <a href={`/${lang}/tools/csv-to-json`} className="text-blue-600 hover:underline">convertidor CSV a JSON</a>, el <a href={`/${lang}/tools/base64-converter`} className="text-blue-600 hover:underline">convertidor Base64</a> y el <a href={`/${lang}/tools/regex-tester`} className="text-blue-600 hover:underline">tester de expresiones regulares</a>.</>}
            {lang === 'fr' && <>Si vous travaillez avec des données structurées, notre <a href={`/${lang}/tools/csv-to-json`} className="text-blue-600 hover:underline">convertisseur CSV vers JSON</a>, le <a href={`/${lang}/tools/base64-converter`} className="text-blue-600 hover:underline">convertisseur Base64</a> et le <a href={`/${lang}/tools/regex-tester`} className="text-blue-600 hover:underline">testeur de regex</a> pourraient vous être utiles.</>}
            {lang === 'de' && <>Wenn Sie mit strukturierten Daten arbeiten, könnten auch unser <a href={`/${lang}/tools/csv-to-json`} className="text-blue-600 hover:underline">CSV zu JSON Konverter</a>, der <a href={`/${lang}/tools/base64-converter`} className="text-blue-600 hover:underline">Base64-Konverter</a> und der <a href={`/${lang}/tools/regex-tester`} className="text-blue-600 hover:underline">Regex-Tester</a> nützlich sein.</>}
            {lang === 'pt' && <>Se você trabalha com dados estruturados, nosso <a href={`/${lang}/tools/csv-to-json`} className="text-blue-600 hover:underline">conversor CSV para JSON</a>, o <a href={`/${lang}/tools/base64-converter`} className="text-blue-600 hover:underline">conversor Base64</a> e o <a href={`/${lang}/tools/regex-tester`} className="text-blue-600 hover:underline">testador de regex</a> podem ser úteis.</>}
          </p>
        </article>
